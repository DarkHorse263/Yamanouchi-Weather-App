...
Title: Cookies and similar technologies | ICO
Fetched: 2026-09-16T00:57:57.762Z

[Skip to main content](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#main-content)
...
This page is based on the previous version of the detailed cookies guidance. We are currently consulting on a revised version of our [guidance on the use of storage and access technologies](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/ "Guidance on the use of storage and access technologies (1)"). This page will be updated once the detailed guidance is finalised.
...
- [What is a cookie?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#whatis)
- [What do we need to do to comply?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#compliance)
- [What else is covered, apart from cookies?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#whatelseiscovered)
- [What information must we give users?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#userinfo)
- [What counts as consent?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#consent)
- [Do we need consent from the subscriber or from the user?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#userconsent)
- [Are there any exemptions?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#exemptions)
- [Do the rules still apply if the data is anonymous?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#anonymousdata)
- [Where can we get more information?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#moreinfo)
- [How do these rules affect apps?](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#apps)
- [Checklists](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#checklists)
...
This means the same rules apply to any similar technologies – such as Local Shared Objects (sometimes called Flash cookies) – and can also cover other types of technology, including [apps](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#apps) on smartphones, tablets, smart TVs or other devices.
...
This is similar to the [transparency requirements](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/individual-rights/individual-rights/right-to-be-informed/ "Right to be informed") of the UK GDPR (privacy notices).

**Further Reading**

For further information, see our detailed [guidance on cookies](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/ "Guidance on the use of storage and access technologies") and the section of the Guide to the UK GDPR on the [right to be informed](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/individual-rights/individual-rights/right-to-be-informed/ "Right to be informed").
...
For more advice on obtaining consent, including the rules on browser settings, see our [guidance on cookies](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/ "Guidance on the use of storage and access technologies") and our [consent guidance](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/lawful-basis/a-guide-to-lawful-basis/consent/ "Consent").

**Further Reading**

For further information, see our detailed [guidance on cookies](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/ "Guidance on the use of storage and access technologies"), as well as our [consent guidance](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/lawful-basis/a-guide-to-lawful-basis/consent/ "Consent") in the Guide to the UK GDPR.

## Do we need consent from the subscriber or from the user?

Regulation 6 states that consent should be obtained from the [subscriber or user](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/key-concepts-and-definitions/#subscribers "Key concepts and definitions").
...
For further information, see our detailed [guidance on cookies](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/ "Guidance on the use of storage and access technologies").
...
For further information, see our [guidance on cookies](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/ "Guidance on the use of storage and access technologies").

You may also want to refer to the opinion adopted by European data protection authorities in June 2012  ( [Article 29 Working Party opinion 04/2012](http://ec.europa.eu/justice/data-protection/article-29/documentation/opinion-recommendation/files/2012/wp194_en.pdf "Article 29 Working Party opinion 04/2012")), which clarifies that some usage of session-ID cookies, multimedia cookies, and user interface customisation cookies (eg language-preference cookies) is likely to fall within the information society services exemption.
...
See our separate [Guide to UK GDPR](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/ "UK GDPR guidance and resources") for more information.

## Where can we get more information?

For more detailed information and practical advice on this topic, see our [guidance on cookies](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/ "Guidance on the use of storage and access technologies").

The ICO will continue to take a risk-based approach to enforcement in this area, taking into account the level of intrusion, the efforts made to provide clear information and get consent, and consumer concern. You can find more about the action we are taking on cookies on [the Enforcement section of the ICO website](https://ico.org.uk/action-weve-taken/enforcement/ "Enforcement").

## How do these rules affect apps?

Apps store information on smart devices, and some apps may also access information on the device (eg contacts or photos). App developers should therefore provide clear information to users about what the app does, and exactly how it uses their information, **before** users click to install the app. It is also important to consider user privacy controls and avoid switching optional features on by default. This ties in closely with the requirements of the Data Protection Act andthe UK GDPR.

**Further reading – ICO guidance**

For more information on how to comply, see our separate guidance [Privacy in mobile apps](https://ico.org.uk/media2/migrated/2346/apps-consumer-guide.pdf "Using apps safely and securely"). Although written under the 1998 Act, it may still assist you.
...
[Back to top](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guide-to-pecr/cookies-and-similar-technologies/#top)