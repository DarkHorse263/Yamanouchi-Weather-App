...
- **Sapporo region added (July 2026)** — 13th JP region: Sapporo Teine / Sapporo Kokusai / Sapporo Bankei, towns Sapporo + Jozankei. Owner is working through an expansion list (Minakami, Kusatsu-Manza, Hachimantai, Bandai, western Japan remain) — proposed as project tasks; new areas follow the generic pattern, mirror `src/regions/sapporo.ts`.
