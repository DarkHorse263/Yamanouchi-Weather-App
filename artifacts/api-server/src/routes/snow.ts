...
const FALLBACK_RESORTS = [
  ...
  { id: "shiga-kumanoyu",            name: "Kumanoyu",                  nameJa: "熊の湯",                region: "Shiga Kogen", regionJa: "志賀高原", snow24h: 0, baseDepth: 205, temp: -3.2, wind: 5.6, snowTomorrow: 0, snowScore: 86, rank: 16, weatherStation: "Shiga Kogen Kumanoyu",  sourceUpdatedAt: null, lat: 36.8107, lng: 138.5248, elevation: 2000, websiteUrl: "https://www.kumanoyu.com/" },
