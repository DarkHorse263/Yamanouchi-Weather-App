...
const LOCATIONS: LocationConfig[] = [
  ...
  },
  {
    ...
    longitude: 138.4767,
    elevation: 1700,
    description: "X-Jam Takaifuji on the north flank of Shiga Kogen. Family terrain with night skiing and direct shuttle from Yudanaka onsen town.",
    bomStation: "",
    bomStationId: "",
    bomWmoId: 0,
    timezone: "Asia/Tokyo",
  ...
  },
  {
    ...
    longitude: 138.4253,
    elevation: 1240,
    description: "Locals' mountain on the Yomase river. Night skiing, gentle terrain, and an onsen finish straight off the slopes.",
    bomStation: "",
    bomStationId: "",
    bomWmoId: 0,
    timezone: "Asia/Tokyo",
  ...
  },
  {
    ...
    longitude: 138.5097,
    elevation: 2009,
    description: "Highest of the Shiga Kogen sub-resorts and home of the 1998 Olympic GS course. Long top-to-bottom groomers above the trees.",
    bomStation: "",
    bomStationId: "",
    bomWmoId: 0,
    timezone: "Asia/Tokyo",
  ...
  },
  {
    ...
    longitude: 138.5214,
    elevation: 1960,
    description: "Quietest, most remote sub-resort of Shiga Kogen. Long, uncrowded groomers and a powder pocket that holds longer than the rest of the area.",
    bomStation: "",
    bomStationId: "",
    bomWmoId: 0,
    timezone: "Asia/Tokyo",
  ...
  {
    id: "ichinose",
    name: "Ichinose Family",
    latitude: 36.7228,
    longitude: 138.5050,
    elevation: 1830,
    description: "Central Shiga Kogen base — easiest gateway to the connected lift system, with the broadest beginner-to-intermediate terrain.",
    bomStation: "",
    bomStationId: "",
    bomWmoId: 0,
    timezone: "Asia/Tokyo",
