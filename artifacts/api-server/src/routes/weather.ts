...
const LOCATIONS: LocationConfig[] = [
  ...
  { id: "ryuoo",                     name: "Ryuoo Ski Park",            latitude: 36.7790, longitude: 138.4500, elevation: 1930, description: "Signature Kita-Shiga gondola-served resort. SORA terrace at 1770m, panoramic views over the Northern Alps.",              bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  { id: "madarao",                   name: "Madarao",                   latitude: 36.8483, longitude: 138.2799, elevation: 1382, description: "Tree-run-famous Madarao · shared 2-mountain pass with Tangram across the ridge.",                                  bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  { id: "tangram",                   name: "Tangram",                   latitude: 36.8504, longitude: 138.2642, elevation: 1148, description: "Niigata-side base of the Madarao massif · family-oriented, lift-linked to Madarao.",                              bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  { id: "togari-onsen",              name: "Togari Onsen",              latitude: 36.9400, longitude: 138.3748, elevation: 1050, description: "Quiet onsen-side mountain · long beginner-intermediate runs above the village.",                                  bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  { id: "kijimadaira",               name: "Kijimadaira · Romance no Kamisama", latitude: 36.8186, longitude: 138.4047, elevation: 1351, description: "Rebranded 2023 from Kita-Shinshu Kijimadaira · wide groomers and family terrain on Mt Kayano.",                          bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  { id: "kijima-snow-park",          name: "Kijima Snow Park",          latitude: 36.8135, longitude: 138.3966, elevation:  700, description: "Snow play and toboggan park (Makinoiri Kogen) · sledding, snow tubing, kids' first-time terrain.",              bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  { id: "happo-one",                 name: "Hakuba Happo-One",          latitude: 36.6968, longitude: 137.8380, elevation: 1831, description: "Hakuba's biggest and steepest · 1998 Olympic downhill runs and long Northern Alps views.",                    bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  { id: "hakuba-goryu",              name: "Hakuba Goryu",              latitude: 36.6645, longitude: 137.8325, elevation: 1676, description: "Gentle Toomi base to steep Alps Daira up top · one ticket shared with neighbouring Hakuba 47.",              bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  { id: "hakuba-47",                 name: "Hakuba 47",                 latitude: 36.6780, longitude: 137.8390, elevation: 1614, description: "Renowned terrain park and tree runs · lift-linked and one ticket with Hakuba Goryu.",                        bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  { id: "hakuba-iwatake",            name: "Hakuba Iwatake",            latitude: 36.7220, longitude: 137.8400, elevation: 1289, description: "Rounded family mountain · home of the Hakuba Mountain Harbor deck, open in the green season too.",           bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  { id: "jiigatake",                 name: "Jiigatake",                 latitude: 36.5604, longitude: 137.8013, elevation: 1205, description: "Gentle south-end learner hill in Omachi · wide easy slopes for first-timers and families.",                bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  { id: "furano-ski-resort",         name: "Furano Ski Resort",         latitude: 43.3326, longitude: 142.3281, elevation: 1074, description: "Prince-run flagship of central Hokkaido · two linked zones with about 950 m of vertical, on the Ikon Pass.",  bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  { id: "sapporo-kokusai",           name: "Sapporo Kokusai",           latitude: 43.0730, longitude: 141.0702, elevation: 900,  description: "Deep-snow local favourite above Jozankei onsen · wide gondola-served cruisers in one of the city's heaviest snow pockets.", bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  { id: "shizukuishi-resort",        name: "Shizukuishi",               latitude: 39.7844, longitude: 140.9203, elevation: 1128, description: "Prince-operated hill on Takakura · about 700 m of vertical, host of the 1993 Alpine World Championships.",       bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  { id: "minakami-kogen",            name: "Minakami Kogen",            latitude: 36.8572, longitude: 139.0807, elevation: 1050, description: "Family resort around the ski-in Hotel 200 · gentle wide courses at the quiet top of the valley.",              bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  { id: "hachimantai-panorama",      name: "Hachimantai Panorama",      latitude: 39.8840, longitude: 140.9775, elevation:  750, description: "Gentle family hill behind the Hachimantai Mountain Hotel · wide north-facing courses with Mt Iwate views.",     bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  { id: "hachimantai-shimokura",     name: "Hachimantai Shimokura",     latitude: 39.8954, longitude: 140.9408, elevation:  930, description: "Powder hill on Mt Shimokura's east slope · wind-sheltered tree lines and very dry 'ultralight' snow.",           bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "Asia/Tokyo", region: "JP" },
  ...
  // The lake/valley towns (Kelowna/Vernon/Penticton/Kamloops) are
  // coordinate-based in the client, so they get no LOCATIONS row · the
  // Sun Peaks village keeps its row from its Powder Highway days.
  ...
  { id: "tremblant",                 name: "Tremblant",                 latitude:  46.2100, longitude:  -74.5850, elevation:  875, description: "Eastern Canada's largest ski area · four faces off Pic White down to the pedestrian village.",         bomStation: "", bomStationId: "", bomWmoId: 0, timezone: "America/Toronto", region: "CA" },
