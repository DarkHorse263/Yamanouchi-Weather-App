  ...
  // (Cabramurra) and the resort village cams for in-park visibility.
  {
    ...
    webcams: [
      ...
      },
      {
        ...
        name: "Kosciuszko Rd at Perisher Valley",
        description: "Live Traffic NSW alpine camera at the Perisher Valley turnoff — the highest point on Kosciuszko Rd, often the first place to ice over.",
        imageUrl: "https://www.livetraffic.com/Map/Resources/Cameras/KosciuszkoRdPerisherValley.jpg",
        pageUrl: "https://www.livetraffic.com/desktop.html#/map/?lat=-36.405&lng=148.412&zoom=16&layers=cameras",
        elevation: 1720,
        type: "road",
        roadName: "Kosciuszko Road",
      },
      {
        ...
        name: "Kosciuszko Rd at Alpine Way",
        description: "Live Traffic NSW camera at the Kosciuszko Rd / Alpine Way junction — the decision point between heading up to Perisher or across to Thredbo.",
        imageUrl: "https://www.livetraffic.com/Map/Resources/Cameras/KosciuszkoRdAlpineWay.jpg",
        pageUrl: "https://www.livetraffic.com/desktop.html#/map/?lat=-36.435&lng=148.582&zoom=16&layers=cameras",
        type: "road",
        roadName: "Kosciuszko Road",
      },
      {
        id: "smh-kosciuszko-wilsons-valley",
        name: "Kosciuszko Rd at Wilsons Valley",
        description: "Live Traffic NSW camera at Wilsons Valley on Kosciuszko Rd between Sawpit Creek and Smiggin Holes — exposed alpine section, watch for chains.",
        imageUrl: "https://www.livetraffic.com/Map/Resources/Cameras/KosciuszkoRdWilsonsValley.jpg",
        pageUrl: "https://www.livetraffic.com/desktop.html#/map/?lat=-36.385&lng=148.435&zoom=16&layers=cameras",
        elevation: 1580,
        type: "road",
        roadName: "Kosciuszko Road",
      },
