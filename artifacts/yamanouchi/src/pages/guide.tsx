      ...
      {tab === "transport" ? (
        <div className="flex-1 overflow-y-auto px-4 pb-6 space-y-5 mt-4">
            ...
            <div className="bg-white rounded-xl border border-slate-100 p-3.5 space-y-3">
              ...
              <div className="space-y-2 border-t border-slate-100 pt-3">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-slate-600">
                    {t("Round-trip tickets available at ARUYO Info Center near Stop 23. Return is open-dated.", "往復券は23番乗場近くのARUYO案内所で購入可能。帰りは日付フリー。")}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl border border-slate-100 p-3.5 space-y-3">
              ...
              <div className="flex items-center gap-3 bg-slate-50 rounded-lg px-3 py-2">
                <div>
                  ...
                  <p className="text-sm font-black text-slate-800">¥390 / ¥200 child</p>
                </div>
              </div>
              ...
              <div className="border-t border-slate-100 pt-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 text-xs text-blue-600 font-semibold mt-2"
                >
                  <ExternalLink className="w-3 h-3" />
                  {t("Full local bus timetable (SMR)", "ローカルバス全時刻表")}
                </a>
              </div>
            </div>
          </section>
            ...
            <div className="bg-white rounded-xl border border-slate-100 p-3.5 space-y-2">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">{t("Connects all ski areas within the resort · 08:30–17:30 daily", "全スキーエリア間を運行 · 毎日8:30〜17:30")}</p>
                </div>
              </div>
              <div className="flex items-start gap-2 pt-1 border-t border-slate-100">
                <Info className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
                <p className="text-xs text-slate-600">
                  {t("Board at Yamanoeki bus stop — the central hub for all Shiga Kogen shuttle services.", "山ノ駅バス停が志賀高原シャトルの中心拠点です。")}
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-3.5 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <p className="text-[10px] text-indigo-500">{t("Includes park entry + round-trip express bus", "公苑入場料+往復急行バス込")}</p>
                </div>
                <div>
                  <p className="text-[10px] text-indigo-400 font-bold uppercase tracking-wide">{t("Train / Local Bus version", "電車/ローカルバス版")}</p>
                  <p className="text-sm font-black text-indigo-900">¥5,100 / ¥2,550</p>
                  <p className="text-[10px] text-indigo-500">{t("Nagano Dentetsu rail + local bus + park entry", "長電+ローカルバス+公苑入場料")}</p>
                </div>
              </div>
              <p className="text-[10px] text-indigo-500">
                {t("⚠ Note: Snow Monkey Pass does NOT cover Shiga Kogen buses. Buy in-person at Nagano Station.", "⚠ スノーモンキーパスは志賀高原行きバスには使用不可。長野駅で購入。")}
              </p>
              <a
          ...
          <p className="text-[10px] text-slate-400 text-center pb-2">
            {t("Timetables correct as of Winter 2025/26. Always verify with the operator before travel.", "時刻表は2025/26シーズン現在のものです。ご利用前に必ず運行会社にご確認ください。")}
          </p>
        </div>
      ) : (
        <div className="flex flex-col flex-1 mt-3">
          <div className="flex items-center justify-end px-4 py-1.5 border-b border-border shrink-0">
            <a
              href={GUIDE_URL}
              target="_blank"
              rel="noopener noreferrer"
