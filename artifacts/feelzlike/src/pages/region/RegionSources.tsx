...
/** New York has no dedicated daily avalanche forecast authority. DEC's irregular High Peaks notices are backcountry-specific, not a standing resort bulletin. */
const NY_OFFICIAL_REFERENCES_NO_AVALANCHE: SourceGroup = { title: "Official references", titleJa: "公式参照先", blurb: "Link-outs, not wired feeds · conditions shown on feelzlike come from the forecast ensemble below. New York has no dedicated avalanche center or daily danger rating. NY DEC may issue irregular Adirondack High Peaks backcountry advisories; this is not a resort-terrain forecast.", blurbJa: "リンクのみで、データ連携はしていません。ニューヨーク州には日次の専用雪崩予報機関がありません。", items: [{ label: "National Weather Service", detail: "US federal forecasts & warnings", url: "https://www.weather.gov/" }] };
const NY_ROADS_GENERAL: SourceGroup = { title: "Roads & transport", titleJa: "道路・交通", blurb: "NYSDOT / 511NY is the state road authority. New York has no general chain law; V&T §145-c applies only to specifically declared snow-emergency routes, not a standing resort-road rule.", blurbJa: "ニューヨーク州には一般的なチェーン義務はありません。", items: [{ label: "NYSDOT · 511NY", detail: "state authority and real-time road conditions / camera map", url: "https://511ny.org/" }, { label: "NYSDOT travel", detail: "state transport authority", url: "https://www.dot.ny.gov/travel" }] };

const MI_OFFICIAL_REFERENCES: SourceGroup = { title: "Official references", titleJa: "公式参照先", blurb: "Link-outs, not wired feeds · Michigan has no avalanche forecasting authority because the state's low-relief ski terrain has no meaningful avalanche hazard; this is a genuine non-issue, not a coverage gap.", blurbJa: "リンクのみです。ミシガン州のスキー地形に雪崩リスクはありません。", items: [{ label: "National Weather Service", detail: "US federal forecasts & warnings", url: "https://www.weather.gov/" }] };
const MI_ROADS: SourceGroup = { title: "Roads & transport", titleJa: "道路・交通", blurb: "Michigan has no passenger-vehicle chain or winter-tire mandate. Studded tyres have date-based restrictions (Nov 15-Apr 1 statewide, wider Oct 1-May 1 window in the UP/northern Lower Peninsula).", blurbJa: "ミシガン州には乗用車向けチェーン・冬用タイヤ義務はありません。", items: [{ label: "MDOT · Mi Drive", detail: "statewide real-time road conditions, cameras and plow tracking", url: "https://www.michigan.gov/drive" }] };

const PA_OFFICIAL: SourceGroup = { title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Pennsylvania has no avalanche forecasting authority because its groomed, low-relief ski terrain has no meaningful avalanche hazard; this is a genuine non-issue, not a gap.",blurbJa:"リンクのみです。ペンシルベニア州の雪崩リスクは実質ありません。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}] };
const PA_ROADS: SourceGroup = { title:"Roads & transport",titleJa:"道路・交通",blurb:"No general passenger chain or winter-tire mandate. PennDOT operates three severe-weather commercial chain-up zones and storm-activated commercial restrictions; ordinary passenger vehicles are not generally mandated.",blurbJa:"乗用車向けの一般的なチェーン義務はありません。",items:[{label:"PennDOT · 511PA",detail:"statewide real-time road conditions, alerts and camera map",url:"https://www.511pa.com/"}] };

const MA_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Massachusetts has no avalanche forecasting authority because its low-relief, groomed ski terrain has no meaningful avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。マサチューセッツ州に実質的な雪崩リスクはありません。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const MA_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No general passenger chain or winter-tire mandate. Studded tires are permitted only Nov 1-Apr 30.",blurbJa:"乗用車向けの一般的なチェーン・冬用タイヤ義務はありません。",items:[{label:"MassDOT · Mass511",detail:"statewide traffic, alerts and camera map",url:"https://mass511.com/"}]};

const MN_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Minnesota has no avalanche authority because North Shore terrain has no meaningful avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。ミネソタ州の雪崩リスクは実質ありません。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const MN_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No passenger chain or winter-tire mandate; studded tires are banned year-round for Minnesota residents. Highway 61 can close suddenly in Lake Superior lake-effect snow.",blurbJa:"乗用車向けのチェーン義務はありません。スタッドレスタイヤは禁止です。",items:[{label:"MnDOT · 511 Minnesota",detail:"real-time road conditions, cameras, plows and closures",url:"https://511mn.org/"}]};

const WI_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Wisconsin has no avalanche forecasting authority because its low-relief ski terrain has no meaningful avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。ウィスコンシン州の雪崩リスクは実質ありません。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const WI_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No passenger chain or winter-tire mandate. Chains are permitted when conditions require them; studded tires are restricted for most passenger vehicles.",blurbJa:"乗用車向けの一般的なチェーン義務はありません。",items:[{label:"WisDOT · 511 Wisconsin",detail:"statewide real-time road conditions and camera map",url:"https://511wi.gov/"}]};

const WV_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · West Virginia has no avalanche forecasting authority because its moderate, groomed Appalachian ski terrain has no meaningful avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const WV_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No standing statewide passenger chain mandate. Chains are permitted for safety; any restriction is conditions-triggered and posted by WVDOT.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"WVDOT · WV 511",detail:"real-time road conditions, cameras and closures",url:"https://wv511.org/"}]};

const NC_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · North Carolina has no avalanche forecasting authority because its groomed Southern Appalachian ski terrain has no meaningful avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const NC_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No standing statewide passenger chain mandate. Resort-adjacent mountain villages may impose local, activated winter restrictions.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"NCDOT · DriveNC",detail:"real-time road conditions, cameras and closures",url:"https://www.drivenc.gov/"}]};

const VA_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Virginia has no avalanche forecasting authority because its moderate, groomed ski terrain has no meaningful avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const VA_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No standing statewide passenger chain mandate. Localities may impose local snow-route restrictions.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"VDOT · 511 Virginia",detail:"real-time road conditions, cameras and closures",url:"https://511.vdot.virginia.gov/"}]};

const NV_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Sierra Avalanche Center actively covers the central Sierra in California and Nevada, including a dedicated Diamond Peak page. Treat avalanche conditions as meaningful for Tahoe-side travel and backcountry users.",blurbJa:"リンクのみです。",items:[{label:"Sierra Avalanche Center",detail:"California and Nevada avalanche forecasts",url:"https://www.sierraavalanchecenter.org/"}]};
const NV_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No fixed statewide chain season; NDOT can require traction devices on signed Sierra passes and highways during storms.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"NDOT · Nevada 511",detail:"real-time road conditions, cameras and closures",url:"https://www.nvroads.com/roadconditions"}]};

const AZ_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Arizona has no formal statewide avalanche forecasting authority, but Arizona Snowbowl’s Upper Bowl has genuine informal avalanche-terrain risk. Backcountry/uphill users should follow local patrol and closure guidance.",blurbJa:"リンクのみです。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const AZ_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No fixed statewide chain season; ADOT can post Chains or 4WD Required restrictions on high-country routes during storms.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"ADOT · AZ511",detail:"real-time road conditions, cameras and closures",url:"https://az511.gov/"}]};

const SD_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · South Dakota has no avalanche forecasting authority because Black Hills ski terrain has no meaningful systematic avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const SD_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No fixed statewide chain season; SDDOT can activate traction restrictions on signed state highways during inclement weather, especially in the Black Hills.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"SDDOT · SD511",detail:"real-time road conditions, cameras and closures",url:"https://sd511.org/"}]};

const AK_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Chugach National Forest Avalanche Information Center actively forecasts the Girdwood/Turnagain Pass corridor. This is a serious, documented avalanche risk; Seward Highway closures and fatalities have occurred.",blurbJa:"リンクのみです。",items:[{label:"Chugach National Forest Avalanche Information Center",detail:"Turnagain Pass / Girdwood avalanche forecasts",url:"https://www.cnfaic.org/"}]};
const AK_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No blanket passenger chain mandate. Alaska DOT&PF can post chain requirements during severe conditions; Seward Highway avalanche closures are a material Alyeska access risk.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"Alaska DOT&PF · Alaska 511",detail:"real-time road conditions, cameras and closures",url:"https://511.alaska.gov/"}]};

const CT_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · Connecticut has no avalanche forecasting authority because its low-elevation ski terrain has no meaningful avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const CT_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No standing statewide passenger chain or winter-tire mandate; chains and studs are only legal within the seasonal statutory window.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"ConnDOT · CT Roads",detail:"real-time road conditions, cameras and closures",url:"https://ctroads.org/"}]};

const NJ_OFFICIAL: SourceGroup={title:"Official references",titleJa:"公式参照先",blurb:"Link-outs, not wired feeds · New Jersey has no avalanche forecasting authority because its low-elevation ski terrain has no meaningful avalanche hazard; this is a genuine non-issue.",blurbJa:"リンクのみです。",items:[{label:"National Weather Service",detail:"US federal forecasts & warnings",url:"https://www.weather.gov/"}]};
const NJ_ROADS: SourceGroup={title:"Roads & transport",titleJa:"道路・交通",blurb:"No standing statewide passenger chain or winter-tire mandate; chains may be used when roads are actually slippery.",blurbJa:"道路状況を出発前に確認してください。",items:[{label:"NJDOT · 511NJ",detail:"real-time road conditions, cameras and closures",url:"https://511nj.org/"}]};

const REGION_SOURCES: Record<string, SourceGroup[]> = {
  "lake-placid": [NY_OFFICIAL_REFERENCES_NO_AVALANCHE, NY_ROADS_GENERAL, { title: "Resorts & lifts", titleJa: "スキー場・リフト", items: [{ label: "Whiteface Mountain", detail: "ORDA state-owned · shared SKI3 pass · new Mountain Collective 2025-26 · total 3,430 ft vs ~3,166 ft lift-served vertical · ⚠️ close date/cam URL unconfirmed", url: "https://whiteface.com/mountain/conditions/" }] }, FORECAST_ENSEMBLE],
  "north-creek": [NY_OFFICIAL_REFERENCES_NO_AVALANCHE, NY_ROADS_GENERAL, { title: "Resorts & lifts", titleJa: "スキー場・リフト", items: [{ label: "Gore Mountain", detail: "ORDA state-owned · shared SKI3 pass with Whiteface and Belleayre · official webcam page confirmed", url: "https://goremountain.com/the-mountain/conditions/" }] }, FORECAST_ENSEMBLE],
  "hunter": [NY_OFFICIAL_REFERENCES_NO_AVALANCHE, NY_ROADS_GENERAL, { title: "Resorts & lifts", titleJa: "スキー場・リフト", items: [{ label: "Hunter Mountain", detail: "Vail Resorts-owned · Epic Pass · ⚠️ projected 2025-26 closing date not resort-confirmed", url: "https://www.huntermtn.com/the-mountain/mountain-conditions/" }] }, FORECAST_ENSEMBLE],
  "windham": [NY_OFFICIAL_REFERENCES_NO_AVALANCHE, NY_ROADS_GENERAL, { title: "Resorts & lifts", titleJa: "スキー場・リフト", items: [{ label: "Windham Mountain Club", detail: "private semi-private club · officially exited Ikon 2025-26, first resort ever to leave · reported $175k-$200k memberships · public access and official 1,600 ft vertical (~1,400-1,450 ft community dispute) require verification · cam live status unconfirmed", url: "https://www.windhammountainclub.com/mountain-report/" }] }, FORECAST_ENSEMBLE],
  "highmount": [NY_OFFICIAL_REFERENCES_NO_AVALANCHE, NY_ROADS_GENERAL, { title: "Resorts & lifts", titleJa: "スキー場・リフト", items: [{ label: "Belleayre Mountain", detail: "ORDA state-owned · shared SKI3 pass with Whiteface and Gore · official webcam page confirmed · ⚠️ projected 2025-26 close not resort-confirmed", url: "https://www.belleayre.com/mountain/conditions/" }] }, FORECAST_ENSEMBLE],
  ...
  "harbor-springs": [MI_OFFICIAL_REFERENCES, MI_ROADS, { title: "Resorts & lifts", titleJa: "スキー場・リフト", items: [{ label: "Boyne Mountain", detail: "Boyne-owned · Ikon Pass / Boyne Passport", url: "https://www.boynemountain.com/" }, { label: "The Highlands", detail: "Boyne-owned · Ikon Pass / Boyne Passport · separate official live webcam URL unconfirmed", url: "https://www.highlandsharborsprings.com/" }, { label: "Nub's Nob", detail: "independent · Indy Pass partner with unusual blackout dates", url: "https://www.nubsnob.com/" }] }, FORECAST_ENSEMBLE],
  "keweenaw-peninsula": [MI_OFFICIAL_REFERENCES, MI_ROADS, { title: "Resorts & lifts", titleJa: "スキー場・リフト", items: [{ label: "Mt. Bohemia", detail: "independent · genuine zero grooming and zero snowmaking · expert-focused · no confirmed official live webcam", url: "https://www.mtbohemia.com/" }] }, FORECAST_ENSEMBLE],
  "poconos": [PA_OFFICIAL, PA_ROADS, { title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Camelback",detail:"⚠️ Vail/Epic ownership confirmed, but Ikon + Peak to Peak Pocono claims require direct re-verification",url:"https://www.camelbackresort.com/"},{label:"Blue Mountain PA",detail:"Ikon partner · PA's highest vertical drop",url:"https://www.skibluemt.com/"},{label:"Shawnee Mountain",detail:"independent · Indy Pass · no confirmed webcam",url:"https://shawneemt.com/"}]},FORECAST_ENSEMBLE],
  "laurel-highlands": [PA_OFFICIAL, PA_ROADS, { title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Seven Springs",detail:"Vail/Epic · Pennsylvania's largest by acreage",url:"https://www.7springs.com/"},{label:"Blue Knob",detail:"independent · Indy Pass · Pennsylvania's highest-elevation ski mountain · webcam unresolved",url:"https://blueknob.com/"}]},FORECAST_ENSEMBLE],
  "berkshires": [MA_OFFICIAL,MA_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Jiminy Peak",detail:"independent · Ikon Bonus Mountain",url:"https://www.jiminypeak.com/"},{label:"Ski Butternut",detail:"independent · Ikon Bonus Mountain",url:"https://skibutternut.com/"},{label:"Berkshire East",detail:"Indy Pass · acquired by Bear Den Partners in 2026 · longer 45-58 min regional drive · no confirmed live webcam",url:"https://berkshireeast.com/"}]},FORECAST_ENSEMBLE],
  "central-massachusetts": [MA_OFFICIAL,MA_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Wachusett Mountain",detail:"independent · “Boston's Mountain” day-trip identity · distinct camera URL unconfirmed",url:"https://www.wachusett.com/"}]},FORECAST_ENSEMBLE],
  "lutsen-north-shore": [MN_OFFICIAL,MN_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Lutsen Mountains",detail:"Indy Pass in 2025-26 · ⚠️ confirmed Ikon move in 2026-27 · Minnesota’s largest/highest vertical, not Midwest highest",url:"https://www.lutsen.com/"}]},FORECAST_ENSEMBLE],
  "wausau": [WI_OFFICIAL,WI_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Granite Peak",detail:"Midwest Family Ski Resorts, not Nash/Skyline · Indy 2025-26 · ⚠️ Ikon 2026-27",url:"https://www.skigranitepeak.com/"}]},FORECAST_ENSEMBLE],
  "wisconsin-dells": [WI_OFFICIAL,WI_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Cascade Mountain",detail:"independent Walz-family ownership · no multi-resort pass (not Indy) · ⚠️ Flash webcam likely broken",url:"https://www.cascademountain.com/"}]},FORECAST_ENSEMBLE],
  "snowshoe": [WV_OFFICIAL,WV_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Snowshoe Mountain",detail:"Ikon Pass / Alterra · Mid-Atlantic’s largest vertical (~1,500 ft) · snowmaking is central to operations · ⚠️ distinct first-party conditions URL not independently confirmed.",url:"https://www.snowshoemtn.com/"}]},FORECAST_ENSEMBLE],
  "canaan-valley": [WV_OFFICIAL,WV_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Canaan Valley Resort",detail:"West Virginia State Park system / state-owned resort · ⚠️ exact 2025–26 dates and current pass affiliation require direct confirmation.",url:"https://www.canaanresort.com/"},{label:"Timberline Mountain",detail:"Independent (not Indy, Epic or Ikon) · correctly grouped in Canaan Valley, not Snowshoe · core snowmaking operations.",url:"https://timberlinemountain.com/"}]},FORECAST_ENSEMBLE],
  "high-country": [NC_OFFICIAL,NC_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Sugar Mountain",detail:"Independent (not Indy, Epic or Ikon) · heavy snowmaking reliance · ⚠️ dedicated live conditions URL not independently confirmed.",url:"https://skisugar.com/"},{label:"Beech Mountain Resort",detail:"Independent · use beechmountainresort.com (ski operations), not beechmtn.com tourism site · heavy snowmaking reliance · ⚠️ webcam live status needs in-season confirmation.",url:"https://www.beechmountainresort.com/"}]},FORECAST_ENSEMBLE],
  "maggie-valley": [NC_OFFICIAL,NC_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Cataloochee Ski Area",detail:"Indy Pass · independently owned · “First in Skiing in the South” · heavy snowmaking reliance.",url:"https://cataloochee.com/"}]},FORECAST_ENSEMBLE],
  "blue-ridge": [VA_OFFICIAL,VA_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Wintergreen Resort",detail:"Indy Pass (recent addition) · ownership history: James C. Justice II → EPR Properties → Pacific Group Resorts · heavy snowmaking reliance.",url:"https://www.wintergreenresort.com/"}]},FORECAST_ENSEMBLE],
  "shenandoah-valley": [VA_OFFICIAL,VA_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Massanutten Resort",detail:"Indy Pass · four-season resort · heavy snowmaking reliance · ⚠️ exact 2025–26 closing day and dedicated first-party webcam URL unconfirmed.",url:"https://www.massresort.com/"}]},FORECAST_ENSEMBLE],
  "lake-tahoe-nevada": [NV_OFFICIAL,NV_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Mt. Rose Ski Tahoe",detail:"Independent · Tahoe’s highest base elevation (8,260 ft) · ⚠️ 2025–26 close-date sources conflict; official snow-report figure preferred.",url:"https://skirose.com/"},{label:"Diamond Peak",detail:"Independent; operated by Incline Village General Improvement District · Sierra Avalanche Center has a dedicated Diamond Peak page · actual 2025–26 close was March 29 after warm weather.",url:"https://www.diamondpeak.com/"}]},FORECAST_ENSEMBLE],
  "flagstaff": [AZ_OFFICIAL,AZ_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Arizona Snowbowl",detail:"Independent proprietary Power Pass · high-elevation, snowmaking-reliant operation · ⚠️ Upper Bowl has genuine informal avalanche-terrain risk despite no formal state forecast center.",url:"https://www.snowbowl.ski/"}]},FORECAST_ENSEMBLE],
  "white-mountains-az": [AZ_OFFICIAL,AZ_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Sunrise Park Resort",detail:"White Mountain Apache Tribe-owned · Indy Pass · ⚠️ summit reports conflict (~10,924 vs 11,000 ft) and require direct resort confirmation; no confirmed webcam URL.",url:"https://www.sunrise.ski/"}]},FORECAST_ENSEMBLE],
  "black-hills": [SD_OFFICIAL,SD_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Terry Peak",detail:"Indy Pass · summit 7,100 ft / ~1,100-ft vertical · ⚠️ standalone conditions and confirmed live webcam URLs remain unresolved",url:"https://terrypeak.com/"}]},FORECAST_ENSEMBLE],
  "girdwood": [AK_OFFICIAL,AK_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Alyeska Resort",detail:"Ikon Pass since 2023 · Pomeroy Lodging-owned · defining aerial tram · ⚠️ elevation/vertical figures vary depending on whether tram-served terrain is included.",url:"https://www.alyeskaresort.com/"}]},FORECAST_ENSEMBLE],
  "juneau": [AK_OFFICIAL,AK_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Eaglecrest Ski Area",detail:"City and Borough of Juneau-owned · ⚠️ material operational risk: roughly $1M/year city subsidy, gondola cancelled May 2026, staff reductions and future beyond 2026–27 uncertain · no confirmed webcam feed.",url:"https://skieaglecrest.com/"}]},FORECAST_ENSEMBLE],
  "litchfield-hills": [CT_OFFICIAL,CT_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Mohawk Mountain",detail:"Indy Pass · 100% snowmaking · historically credited as the birthplace of modern snowmaking · ⚠️ 2025–26 closing date is not primary-source confirmed.",url:"https://www.mohawkmtn.com/"}]},FORECAST_ENSEMBLE],
  "vernon": [NJ_OFFICIAL,NJ_ROADS,{title:"Resorts & lifts",titleJa:"スキー場・リフト",items:[{label:"Mountain Creek Resort",detail:"Independent Snow Partners ownership (acquired from Koffman family in 2018; formerly Snow Operating) · not Vail-owned and not Epic/Ikon/Indy · 100% snowmaking · limited confirmed webcam coverage.",url:"https://mountaincreek.com/"}]},FORECAST_ENSEMBLE],
  "mt-hood": [
