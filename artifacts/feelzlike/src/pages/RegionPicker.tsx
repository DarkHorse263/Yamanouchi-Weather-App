    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-5xl mx-auto px-4 md:px-10 pt-5 md:pt-9 pb-9">
        ...
        >
          ...
          <p className="byline text-slate-700 mt-5">The skier &amp; snowboarder's bible</p>
          ...
          <p className="text-slate-700 text-lg mt-4 max-w-2xl leading-relaxed">
            ...
            >
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="byline text-slate-700 inline-flex items-center gap-1.5">
                    <MapPin className="w-3 h-3" />
                    {region.shortTag}
                  </span>
                  <ArrowRight className="w-4 h-4 text-slate-700 group-hover:text-primary group-hover:translate-x-0.5 transition-all" />
                </div>
                <h2 className="font-display font-semibold text-2xl text-foreground mt-4 leading-tight">
                  {region.name}
                </h2>
                <p className="text-slate-700 text-sm mt-1">{region.subtitle}</p>
        ...
        <p className="byline text-slate-700">v0.3 · feelzlike - single app, all regions</p>
      </div>
    </div>
  );
}
