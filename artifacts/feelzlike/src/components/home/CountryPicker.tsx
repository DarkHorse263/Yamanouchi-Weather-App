...
const FALLBACK_REGIONS: Region[] = [
  ...
  { id: "okanagan",               name: "Okanagan",                       country: "Canada",      countryCode: "CA", region: "BC Interior",      status: "live", href: "/okanagan/",             baseTowns: ["Kelowna", "Vernon", "Penticton"],                            mountains: ["Big White Ski Resort", "SilverStar Mountain Resort", "Apex Mountain Resort"], headlineLabel: "Kelowna", headline: null },
