...
export function seasonForCountry(code: "AU" | "JP" | "NZ" | "CA"): "winter" | "green" {
...
export function CountryPicker() {
  ...
  return (
    <>
      ...
      {/* TRUST LINE */}
      <p
        className="mx-auto mt-6 max-w-md text-center text-[11px] leading-relaxed text-white/60"
        style={balance}
      >
