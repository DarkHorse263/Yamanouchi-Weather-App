...
const FALLBACK_REGIONS: Region[] = [
  ...
  { id: "st-anton",                name: "St Anton am Arlberg",             country: "Austria", countryCode: "AT", region: "Tyrol",      status: "live", href: "/st-anton/",   baseTowns: ["St Anton am Arlberg"], mountains: ["St Anton Resort"], headlineLabel: "St Anton am Arlberg", headline: null },
  ...
  { id: "okanagan",               name: "Okanagan",                       country: "Canada",      countryCode: "CA", region: "BC Interior",      status: "live", href: "/okanagan/",             baseTowns: ["Kelowna", "Vernon", "Penticton", "Kamloops", "Sun Peaks"],   mountains: ["Big White Ski Resort", "SilverStar Mountain Resort", "Apex Mountain Resort", "Sun Peaks Resort"], headlineLabel: "Kelowna", headline: null },
  { id: "vancouver",              name: "Vancouver & the Island",         country: "Canada",      countryCode: "CA", region: "British Columbia", status: "live", href: "/vancouver/",            baseTowns: ["Vancouver", "Courtenay"],                                    mountains: ["Cypress Mountain", "Grouse Mountain", "Mt Seymour", "Mount Washington Alpine Resort"], headlineLabel: "Vancouver", headline: null },
  ...
  {id:"wausau",name:"Wausau",country:"United States",countryCode:"US",region:"Wisconsin",status:"live",href:"/wausau/",baseTowns:["Wausau"],mountains:["Granite Peak Ski Area"],headlineLabel:"Wausau",headline:null},
  {id:"wisconsin-dells",name:"Wisconsin Dells",country:"United States",countryCode:"US",region:"Wisconsin",status:"live",href:"/wisconsin-dells/",baseTowns:["Portage"],mountains:["Cascade Mountain"],headlineLabel:"Portage",headline:null},
  {id:"snowshoe",name:"Snowshoe",country:"United States",countryCode:"US",region:"West Virginia",status:"live",href:"/snowshoe/",baseTowns:["Snowshoe"],mountains:["Snowshoe Mountain"],headlineLabel:"Snowshoe",headline:null},
  {id:"canaan-valley",name:"Canaan Valley",country:"United States",countryCode:"US",region:"West Virginia",status:"live",href:"/canaan-valley/",baseTowns:["Davis / Canaan Valley"],mountains:["Canaan Valley Resort","Timberline Mountain"],headlineLabel:"Davis / Canaan Valley",headline:null},
  {id:"high-country",name:"High Country",country:"United States",countryCode:"US",region:"North Carolina",status:"live",href:"/high-country/",baseTowns:["Banner Elk / Beech Mountain"],mountains:["Sugar Mountain","Beech Mountain Resort"],headlineLabel:"Banner Elk / Beech Mountain",headline:null},
  {id:"maggie-valley",name:"Maggie Valley",country:"United States",countryCode:"US",region:"North Carolina",status:"live",href:"/maggie-valley/",baseTowns:["Maggie Valley"],mountains:["Cataloochee Ski Area"],headlineLabel:"Maggie Valley",headline:null},
  {id:"blue-ridge",name:"Blue Ridge",country:"United States",countryCode:"US",region:"Virginia",status:"live",href:"/blue-ridge/",baseTowns:["Wintergreen"],mountains:["Wintergreen Resort"],headlineLabel:"Wintergreen",headline:null},
  {id:"shenandoah-valley",name:"Shenandoah Valley",country:"United States",countryCode:"US",region:"Virginia",status:"live",href:"/shenandoah-valley/",baseTowns:["McGaheysville"],mountains:["Massanutten Resort"],headlineLabel:"McGaheysville",headline:null},
  {id:"lake-tahoe-nevada",name:"Lake Tahoe Nevada",country:"United States",countryCode:"US",region:"Nevada",status:"live",href:"/lake-tahoe-nevada/",baseTowns:["Incline Village"],mountains:["Mt. Rose Ski Tahoe","Diamond Peak"],headlineLabel:"Incline Village",headline:null},
  {id:"flagstaff",name:"Flagstaff",country:"United States",countryCode:"US",region:"Arizona",status:"live",href:"/flagstaff/",baseTowns:["Flagstaff"],mountains:["Arizona Snowbowl"],headlineLabel:"Flagstaff",headline:null},
  {id:"white-mountains-az",name:"White Mountains",country:"United States",countryCode:"US",region:"Arizona",status:"live",href:"/white-mountains-az/",baseTowns:["Greer"],mountains:["Sunrise Park Resort"],headlineLabel:"Greer",headline:null},
  {id:"black-hills",name:"Black Hills",country:"United States",countryCode:"US",region:"South Dakota",status:"live",href:"/black-hills/",baseTowns:["Lead / Deadwood"],mountains:["Terry Peak"],headlineLabel:"Lead / Deadwood",headline:null},
  {id:"girdwood",name:"Girdwood",country:"United States",countryCode:"US",region:"Alaska",status:"live",href:"/girdwood/",baseTowns:["Girdwood"],mountains:["Alyeska Resort"],headlineLabel:"Girdwood",headline:null},
  {id:"juneau",name:"Juneau",country:"United States",countryCode:"US",region:"Alaska",status:"live",href:"/juneau/",baseTowns:["Juneau"],mountains:["Eaglecrest Ski Area"],headlineLabel:"Juneau",headline:null},
  {id:"litchfield-hills",name:"Litchfield Hills",country:"United States",countryCode:"US",region:"Connecticut",status:"live",href:"/litchfield-hills/",baseTowns:["Cornwall"],mountains:["Mohawk Mountain"],headlineLabel:"Cornwall",headline:null},
  {id:"vernon",name:"Vernon",country:"United States",countryCode:"US",region:"New Jersey",status:"live",href:"/vernon/",baseTowns:["Vernon"],mountains:["Mountain Creek Resort"],headlineLabel:"Vernon",headline:null},
...
const PRIMARY_TOWN: Record<string, string> = {
  ...
  "snowshoe": "Snowshoe",
  "canaan-valley": "Davis / Canaan Valley",
  "high-country": "Banner Elk / Beech Mountain",
  "maggie-valley": "Maggie Valley",
  "blue-ridge": "Wintergreen",
  "shenandoah-valley": "McGaheysville",
  "lake-tahoe-nevada": "Incline Village",
  "flagstaff": "Flagstaff",
  "white-mountains-az": "Greer",
  "black-hills": "Lead / Deadwood",
  "girdwood": "Girdwood",
  "juneau": "Juneau",
  "litchfield-hills": "Cornwall",
  "vernon": "Vernon",
