...
export const nisekoRegion: RegionConfig = {
  ...
  mountains: [
    {
      ...
      websiteUrl: "https://www.grand-hirafu.jp/winter/",
  ...
  tourismLinks: [
    ...
    { category: "Resorts", categoryJa: "スキー場", label: "Niseko Grand Hirafu", labelJa: "ニセコマウンテンリゾート グラン・ヒラフ", url: "https://www.grand-hirafu.jp/winter/" },
