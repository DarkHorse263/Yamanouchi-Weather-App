...
export const rangeleyRegion: RegionConfig = {
  ...
  tourismLinks: [{ category: "Resorts", label: "Saddleback mountain report", url: "https://www.saddlebackmaine.com/mountain-report/" }, { category: "Transport", label: "MaineDOT · 511 Maine", url: "https://www.newengland511.org/region/Maine" }], roadsSource: { label: "MaineDOT · 511 Maine", url: "https://www.newengland511.org/region/Maine", dataAvailable: false }, weatherSource: { label: "Open-Meteo" },
};
