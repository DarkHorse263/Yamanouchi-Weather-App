  ...
  mountains: [
    {
      ...
      name: "Heavenly",
      elevationM: 1907,
      skiBaseElevationM: 1907,
      summitElevationM: 3068,
      lat: 38.9353,
      lng: -119.9400,
      blurb: "Epic Pass · straddles the CA/NV state line above South Lake Tahoe. Check the official resort site for current operating dates.",
    ...
    },
    {
      ...
      name: "Kirkwood",
      elevationM: 2377,
      skiBaseElevationM: 2377,
      summitElevationM: 2987,
      lat: 38.6840,
      lng: -120.0664,
      blurb: "Epic Pass · one of the highest resort base elevations in the Tahoe region. Check the official resort site for current operating dates.",
    ...
    },
    {
      ...
      blurb: "Sierra-at-Tahoe · confirm current opening status and operating dates on the resort's official site before travelling.",
    ...
    },
    {
      ...
      elevationM: 1899,
      skiBaseElevationM: 1899,
      summitElevationM: 2401,
      lat: 39.0827,
      lng: -120.1755,
      blurb: "Independent · West Shore lake views. Check the resort's official site for current operating status.",
