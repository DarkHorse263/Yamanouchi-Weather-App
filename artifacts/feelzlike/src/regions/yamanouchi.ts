...
export const yamanouchiRegion: RegionConfig = {
  ...
  mountains: [
    ...
    { id: "shiga-yakebitaiyama",       name: "Yakebitaiyama",             nameJa: "焼額山",                elevationM: 2009, lat: 36.8195, lng: 138.5310, blurb: "Highest Prince-run sub-resort · 1998 Olympic GS course",          blurbJa: "プリンス系最高峰 · 長野五輪GSコース",                websiteUrl: "https://www.princehotels.com/en/ski/shiga_kogen/", parentId: "shiga-kogen", kids_lessons: true, terrain_park: true },
    ...
    { id: "shiga-yokoteyama",          name: "Yokoteyama",                nameJa: "横手山",                elevationM: 2305, lat: 36.7159, lng: 138.5450, blurb: "Japan's highest lift-served summit · alpine views to the JP Alps", blurbJa: "日本最高所の索道山頂 · 日本アルプスを望む",         websiteUrl: "https://www.shigakogen.gr.jp/english/area/area_detail_yokoteyama.html", parentId: "shiga-kogen", expert_only: true, backcountry_access: true },
    { id: "shiga-shibutoge",           name: "Shibutoge",                 nameJa: "渋峠",                  elevationM: 2172, lat: 36.7044, lng: 138.5364, blurb: "Highest skiable pass on Honshu · sea-of-clouds backdrop",          blurbJa: "本州最高所の峠 · 雲海の眺望",                       websiteUrl: "https://www.shigakogen.gr.jp/english/area/area_detail_yokoteyama.html", parentId: "shiga-kogen", expert_only: true, backcountry_access: true },
    ...
    { id: "xjam-takaifuji",            name: "X-Jam Takaifuji",           nameJa: "X-JAM高井富士",          elevationM: 1330, lat: 36.7506, lng: 138.4767, blurb: "Park-focused resort · biggest jib & jump features in north Nagano", blurbJa: "パーク特化 · 北信最大のジブ・ジャンプアイテム",     websiteUrl: "https://x-jam.jp/", parentId: "kita-shiga", beginner_friendly: true, kids_lessons: true, terrain_park: true },
    { id: "yomase-onsen",              name: "Yomase Onsen",              nameJa: "夜間瀬温泉スキー場",    elevationM: 1240, lat: 36.7714, lng: 138.4253, blurb: "Locals' mountain on the river · night skiing & onsen finish",      blurbJa: "夜間瀬川沿いの地元のスキー場 · ナイター + 温泉",    websiteUrl: "https://x-jam.jp/", parentId: "kita-shiga", beginner_friendly: true },
    { id: "kita-shiga-komaruyama",     name: "Kita-shiga Komaruyama",     nameJa: "北志賀小丸山",          elevationM: 1100, lat: 36.7820, lng: 138.4310, blurb: "Smallest Kita-Shiga resort · gentle beginner laps under the lifts", blurbJa: "北志賀最小のスキー場 · 緩斜面の初心者向け",         websiteUrl: "https://www.komaruyama.jp/", parentId: "kita-shiga", beginner_friendly: true, kids_lessons: true },
  ],
  baseTowns: [
    {
      id: "yudanaka",
  ...
  tourismLinks: [
    ...
    { category: "Resorts", categoryJa: "スキー場", label: "Kita-Shiga Kogen", labelJa: "北志賀高原", url: "https://ryuoo.com/winter/kitashiga/" },
