...
export const yamanouchiRegion: RegionConfig = {
  ...
  resorts: [
    { path: "/resort/shiga-kogen",       label: "Shiga Kogen",       labelJa: "志賀高原" },
    { path: "/resort/yakebitaiyama",     label: "Yakebitaiyama",     labelJa: "焼額山" },
    { path: "/resort/kita-shiga",        label: "Kita-Shiga Kogen",  labelJa: "北志賀高原" },
    { path: "/resort/ryuoo",             label: "Ryuoo",             labelJa: "竜王" },
  ],
