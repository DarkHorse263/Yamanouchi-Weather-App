...
export const carrabassettValleyRegion: RegionConfig = {
  ...
  tourismLinks: [{ category: "Resorts", label: "Sugarloaf mountain report", url: "https://www.sugarloaf.com/mountain-report" }, { category: "Transport", label: "MaineDOT · 511 Maine", url: "https://www.newengland511.org/region/Maine" }],
  roadsSource: { label: "MaineDOT · 511 Maine", url: "https://www.newengland511.org/region/Maine", dataAvailable: false }, weatherSource: { label: "Open-Meteo" },
};
