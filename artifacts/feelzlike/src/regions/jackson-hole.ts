  ...
  mountains: [
    {
      ...
      elevationM: 1924,
      skiBaseElevationM: 1924,
      summitElevationM: 3185,
      lat: 43.5875,
      lng: -110.8279,
      blurb: "Ikon Pass (Full only, excluded from Base) · legendary steep terrain off the Aerial Tram, 4,139 ft vertical. Check the resort for current pass reservation requirements.",
    ...
    },
    {
      ...
      elevationM: 1901,
      skiBaseElevationM: 1901,
      summitElevationM: 2380,
      lat: 43.4783,
      lng: -110.7581,
      blurb: "Indy Pass + Powder Alliance · Wyoming's original ski resort, in-town in Jackson with night skiing. Check the official site for current season dates.",
