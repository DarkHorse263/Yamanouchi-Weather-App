...
export const newryBethelRegion: RegionConfig = {
  ...
  tourismLinks: [{ category: "Resorts", label: "Sunday River mountain report", url: "https://www.sundayriver.com/mountain-report" }, { category: "Transport", label: "MaineDOT · 511 Maine", url: "https://511maine.gov/" }], roadsSource: { label: "MaineDOT · 511 Maine", url: "https://511maine.gov/", dataAvailable: false }, weatherSource: { label: "Open-Meteo" },
};
