...
if (records.length !== 233) {
  throw new Error(`Expected 233 pending-evidence records; found ${records.length}`);
}
...
if (unclearCount !== 208 || essentialGapCount !== 25) {
  throw new Error(
    `Expected 208 unclear and 25 essential-gap records; found ${unclearCount} and ${essentialGapCount}`,
  );
}
