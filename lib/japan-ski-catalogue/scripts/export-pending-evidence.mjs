...
if (records.length !== 207) {
  throw new Error(`Expected 207 pending-evidence records; found ${records.length}`);
}
...
if (unclearCount !== 178 || essentialGapCount !== 29) {
  throw new Error(
    `Expected 178 unclear and 29 essential-gap records; found ${unclearCount} and ${essentialGapCount}`,
  );
}
