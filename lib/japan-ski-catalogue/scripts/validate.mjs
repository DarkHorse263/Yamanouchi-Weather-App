...
check(currentVerified.length === 290, `Expected 290 current verified records; found ${currentVerified.length}`);
check(mappedExisting.length === 56, `Expected 56 existing-page mappings; found ${mappedExisting.length}`);
check(newIdentities.length === 234, `Expected 234 new-page identities; found ${newIdentities.length}`);
